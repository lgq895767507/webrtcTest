...
import com.lgq.my_webrtc.bean.IceServerEntity;
...
public class PeerConnectionManager {
    ...
    public PeerConnectionManager(IWebSocket webSocket, IceServerEntity[] iceServers) {
        this.connectionPeerDic = new HashMap<>();
        this.connectionIdArray = new ArrayList<>();
        this.ICEServers = new ArrayList<>();
        this.webSocket = webSocket;
        executor = Executors.newSingleThreadExecutor();
        PeerConnection.IceServer iceServer = PeerConnection.IceServer.builder("stun:1.117.248.121:3000?transport=udp")
                .setUsername("").setPassword("").createIceServer();
        PeerConnection.IceServer iceServer1 = PeerConnection.IceServer.builder("turn:1.117.248.121:3000?transport=udp")
                .setUsername("liuguoqing").setPassword("123456").createIceServer();
